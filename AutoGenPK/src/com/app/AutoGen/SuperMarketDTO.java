...
/*
 * @NamedQuery(name="getBySlNo", query="from SuperMarketDTO where slNo=:slno")
 * 
 * @NamedQuery(name="getByNoOfEmp",query="from SuperMarketDTO where" +
 * "noOfEmployees=:noOfEmp")
 */

@NamedQueries({ @NamedQuery(name = "getBySlNo", query = "from SuperMarketDTO where slNo=:slno"),

		@NamedQuery(name = "getByNoOfEmp", query = "from SuperMarketDTO where " + "noOfEmployees=:noOfEmp") })
